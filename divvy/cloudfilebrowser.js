    ...
    return {
        ...
        handleOnGetOAuthUrl: function(data, cbArgs) {
            ...
            cbArgs.win.location.href = `
                https://login.microsoftonline.com/common/v2.0/adminconsent?client_id=bb72503e-3a32-417a-a1cc-767d5536feab&state=onedrivebusiness&scope=api://divvyhqdev/files.read.all&response_type=code&redirect_uri=http://localhost:8000/cloudstorage/filebrowser_callback
            `;
        },
